...
instance Functor ListZipper where
  (<$>) f (ListZipper l z r) = ListZipper (f <$> l) (f z) (f <$> r)
...
toList ::
  ListZipper a
  -> List a
toList (ListZipper l z r) = reverse l ++ pure z ++ r
...
withFocus ::
  ...
  -> ListZipper a
  -> ListZipper a
withFocus f (ListZipper l z r)= ListZipper l (f z) r
...
findLeft ::
  ...
  -> ListZipper a
  -> MaybeListZipper a
findLeft f (ListZipper l z r) =
  case break f l of
    (_, Nil) -> isNotZ
    (l', z' :. r') -> isZ $ ListZipper r' z' (reverse l' ++ z :. r)
...
findRight ::
  ...
  -> ListZipper a
  -> MaybeListZipper a
findRight f (ListZipper l z r) =
  case break f r of
    (_ , Nil) -> isNotZ
    (l', z' :. r') -> isZ $ ListZipper (reverse l' ++ z :. l) z' r'
...
moveLeftLoop ::
  ListZipper a
  -> ListZipper a
moveLeftLoop (ListZipper Nil z r) =
  case reverse (z :. r) of
    z' :. l' -> ListZipper l' z' Nil
    _ -> error "impossible"
moveLeftLoop (ListZipper (z' :. l) z r) = ListZipper l z' (z :. r)
...
moveRightLoop ::
  ListZipper a
  -> ListZipper a
moveRightLoop (ListZipper l z Nil) =
  case reverse (z :. l) of
    z' :. r' -> ListZipper Nil z' r'
    _ -> error "impossible"
moveRightLoop (ListZipper l z (z' :. r)) = ListZipper (z :. l) z' r
...
moveLeft (ListZipper (z' :. l) z r) = isZ $ ListZipper l z' (z :. r)
...
moveRight (ListZipper l z (z' :. r)) = isZ $ ListZipper (z :. l) z' r
...
swapLeft (ListZipper (z' :. l) z r) = isZ $ ListZipper (z :. l) z' r
...
swapRight (ListZipper l z (z' :. r)) = isZ $ ListZipper l z' (z :. r)
...
dropLefts ::
  ListZipper a
  -> ListZipper a
dropLefts (ListZipper _ z r) = ListZipper Nil z r
...
dropRights ::
  ListZipper a
  -> ListZipper a
dropRights (ListZipper l z _) = ListZipper l z Nil
...
nth n lz@(ListZipper l _ _)
  ...
  | otherwise =
      case compare (length l) n of
        EQ -> isZ lz
        GT -> moveLeftN (length l - n) lz
        LT -> moveRightN (n - length l) lz
...
-- prop> \lz -> rights (end lz) == Nil
  ...
  ListZipper a
  -> ListZipper a
end lz@(ListZipper l z r) =
  case reverse r of
    (z':. r') -> ListZipper (r' ++ z :. l) z' Nil
    Nil -> lz
...
start ::
  ListZipper a
  -> ListZipper a
start lz@(ListZipper l z r) =
  case reverse l of
    Nil -> lz
    (z' :. l') -> ListZipper Nil z' (l' ++ z :. r)
...
deletePullLeft (ListZipper (z :. l) _ r) = isZ $ ListZipper l z r
...
deletePullRight (ListZipper l _ (z :. r)) = isZ $ ListZipper l z r
...
insertPushLeft ::
  ...
  -> ListZipper a
  -> ListZipper a
insertPushLeft z' (ListZipper l z r) = ListZipper (z :. l) z' r
...
insertPushRight ::
  ...
  -> ListZipper a
  -> ListZipper a
insertPushRight z' (ListZipper l z r) = ListZipper l z' (z :. r)
...
-- /Tip:/ Use `zipWith`
  (<*>) (ListZipper lf f rf) (ListZipper la a ra) = ListZipper (zipWith ($) lf la) (f a) (zipWith ($) rf ra)
...
instance Extend ListZipper where
  (<<=) f z = f <$> unwrap z
    where unwrap lz = ListZipper (unfoldr gl lz) lz (unfoldr gr lz)
          gl lz = case moveLeft lz of
                     MLZ Empty -> Empty
                     MLZ (Full lz') -> Full (lz', lz')
          gr lz = case moveRight lz of
                     MLZ Empty -> Empty
                     MLZ (Full lz') -> Full (lz', lz')
...
instance Traversable ListZipper where
  traverse f (ListZipper l z r) = ListZipper <$> traverse f l <*> f z <*> traverse f r
